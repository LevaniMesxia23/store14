    ...
    <div className=" bg-black font-mikheil">
      <div className=" px-12 py-8">
        <ul className=" flex flex-col  text-white">
          ...
          <div
            className={`flex flex-col gap-3 top-full  p-2 transition-all duration-300 ease-in-out overflow-hidden ${
              menuOpen
                ? "max-h-40 opacity-100 visible py-4"
          ...
          >
            <a target="_blank" href="https://www.instagram.com/burchu.14/">
